  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        en: 'en/index.html',
        enBrands: 'en/brands/index.html',
        enService: 'en/service-retrofit/index.html',
        enReferences: 'en/references/index.html',
        enContact: 'en/contact/index.html',
        enMetso: 'en/metso/index.html',
        enMjRecycling: 'en/mj-recycling/index.html',
        enMfl: 'en/mfl/index.html',
        enOutotec: 'en/outotec/index.html',
      },
    },
  },
})
